...
import com.ciardullo.conjugator.dao.DBConstants;
...
//						"request purchase returned " + responseCode);
	...
	private static final CatalogEntry[] CATALOG = new CatalogEntry[] {
			new CatalogEntry("com.ciardullo.conjugator.italian.1", R.string.buyLevel2, Managed.MANAGED),
			new CatalogEntry("com.ciardullo.conjugator.italian.2", R.string.buyLevel4, Managed.MANAGED),
			new CatalogEntry("com.ciardullo.conjugator.italian.3", R.string.buyLevel8, Managed.MANAGED),
			new CatalogEntry("com.ciardullo.conjugator.italian.0", R.string.buyLevel1, Managed.UNMANAGED) };
